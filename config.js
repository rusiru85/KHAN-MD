...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KHAN-MD~62YFFCqC#M9az5KJvElMOvXdNRKXja1D7XaI1B_BzwWopxnmWUeY",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY RDS 🤍*",
...
OWNER_NAME: process.env.OWNER_NAME || "RDS",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ RDS*",
// add bot owner name    
